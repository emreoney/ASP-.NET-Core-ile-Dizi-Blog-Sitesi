                ...
                <div class="col-md-8 single-main">
                    <div class="single-grid">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                ...
                                <h3 style="margin-top=40px"><%# Eval("BLOGBASLIK") %></h3>
                                <p><%# Eval("BLOGICERIK") %></p>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                        ...
                        <ItemTemplate>
                            <ul class="comment-list">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <p style="font-weight: bolder"><%# Eval("KULLANICIAD") %> </p> : <p> <%# Eval("YORUMCERIK") %> </p>
                                    </div>
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Yorumunuz" TextMode="MultiLine" Height="180"></asp:TextBox> 
