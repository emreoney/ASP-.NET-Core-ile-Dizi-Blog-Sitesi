<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="BlogEkle.aspx.cs" Inherits="DiziProje.BlogEkle" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server" class="form-group">
        ...
        <br />
        <asp:Button ID="EkleButton" runat="server" CssClass="btn btn-primary" Text="Kaydet" OnClick="EkleButton_Click" />
    </form>
